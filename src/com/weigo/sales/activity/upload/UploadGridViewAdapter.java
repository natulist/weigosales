...
public class UploadGridViewAdapter extends BaseAdapter {
	private static final String TAG = UploadGridViewAdapter.class.getSimpleName();
	Context mContext;
	List<ImageInfo> mImageInfos;
	int imageNum;
	int imgSum;

	public UploadGridViewAdapter(Context context, List<ImageInfo> imageInfos, int num) {
		mContext = context;
