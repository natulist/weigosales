...
public class XListView extends ListView implements OnScrollListener 
{
	...
	{
		mHeaderView.setTimeContainerVisible(false);
	}
	
	public XListViewHeader getRefreshHeader() {
		return mHeaderView;
	}
	...
	public void realStopRefresh()
	{
		mPullRefreshing = false;
		mHeaderView.setState(XListViewHeader.STATE_NORMAL);
		resetHeaderHeight();
//		mScroller.startScroll(0, 0, 0, 0,SCROLL_DURATION);
//		invalidate();
	}
